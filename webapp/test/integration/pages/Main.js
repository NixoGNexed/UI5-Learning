sap.ui.require([
  ...
  var sViewName = "com.myorg.ui5learning.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of com.myorg.ui5learning"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.myorg.ui5learning"
            });
        }
      }
